            ...
            <section className="stake-house">
                <div className="stake-house-container">
                    <div className="intro">
                        ...
                        <ConnectBtn />
                        <h2>Web3Club staking contract payout to investors 1.5% a day with a 265% ROI. Web3Club appreciates in value the higher your payout is in USD.
                    ...
                    <div className="stake">
                        <div className="stake-stat">
                            <div className="item">
                                ...
                                <span className="value"> <span id="contract">{vcBalance.toFixed(6)}</span> Web3Club</span>
                            </div>

                            <div className="item">
                                <span className="property">Your Total Deposit</span>
                                <span className="value"> <span id="contract">{totalDeposit.toFixed(6)}</span> Web3Club</span>
                            </div>
                            <div className="item">
                                <span className="property">Total Claimed</span>
                                <span className="value"> <span id="contract">{totalWithdrawn.toFixed(6)}</span> Web3Club</span>
                            </div>
                        </div>
                        ...
                        <div className="stake-rewards">
                            ...
                            <span className="value"> <span id="contract">{dividends.toFixed(6)}</span> Web3Club</span>
                        </div>

                        <div className="stake-rewards">
                            <span className="property">Your Referral Bonus</span>
                            <span className="value"> <span id="contract">{bonus.toFixed(6)}</span> Web3Club</span>
                        </div>
